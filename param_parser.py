...
def parameter_parser():
    ...
    parser.add_argument('--pre_epoch', type=int, default=30, help='epochs for the first stage in training.')
    parser.add_argument('--pre_lr', type=float, default=0.01,  # default = 0.01
                        help='Initial learning rate.')
    parser.add_argument('--post_lr', type=float, default=0.01,  # default = 0.01
                        help='Initial learning rate.')
    ...
    parser.add_argument('--recon_loss_ratio', type=float, default=0,
                        help='Ratio of reconstruction loss to pbnc loss in total loss. Default 0.1.')
    ...
    parser.add_argument('--pbnc_nsvgd', action='store_true', help='Whether to use social balance theory.')
    parser.add_argument('--pbnc_res', action='store_true', help='Whether to use social balance theory.')
    parser.add_argument('--two_step_train', action='store_true', help='Whether to use social balance theory.')
